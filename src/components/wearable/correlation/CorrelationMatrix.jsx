...
/**
 * Correlation matrix heatmap showing pairwise correlations between CPAP and wearable metrics.
 *
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: '0.9em' }}>
            Ensure sufficient nights of combined CPAP and wearable data for
            analysis.
          </p>
        </div>
      </div>
        ...
        <ThemedPlot
          ...
          config={{
            ...
            toImageButtonOptions: {
              format: 'png',
              filename: 'oscar-wearable-correlation-matrix',
              height: 600,
              width: 600,
              scale: 1,
            },
